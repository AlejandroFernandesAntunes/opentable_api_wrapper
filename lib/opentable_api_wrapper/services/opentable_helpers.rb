...
class OpentableHelpers
  COUNTRY_CODES = [
    ...
    { country_code: 'BQ', country: 'British Antarctic Territory' },
    ...
    { country_code: 'CT', country: 'Canton and Enderbury Islands' },
    ...
    { country_code: 'CD', country: 'Congo - Kinshasa' },
    ...
    { country_code: 'NQ', country: 'Dronning Maud Land' },
    { country_code: 'DD', country: 'East Germany' },
    ...
    { country_code: 'HK', country: 'Hong Kong SAR China' },
    ...
    { country_code: 'JT', country: 'Johnston Island' },
    ...
    { country_code: 'UK', country: 'London' },
    { country_code: 'LU', country: 'Luxembourg' },
    { country_code: 'MO', country: 'Macau SAR China' },
    ...
    { country_code: 'FX', country: 'Metropolitan France' },
    { country_code: 'MX', country: 'Mexico' },
    { country_code: 'FM', country: 'Micronesia' },
    { country_code: 'MI', country: 'Midway Islands' },
    ...
    { country_code: 'MM', country: 'Myanmar [Burma]' },
    ...
    { country_code: 'NT', country: 'Neutral Zone' },
    ...
    { country_code: 'BL', country: 'Saint Barthélemy' },
    ...
    { country_code: 'CS', country: 'Serbia and Montenegro' },
    ...
    { country_code: 'ST', country: 'São Tomé and Príncipe' },
    ...
    { country_code: 'UM', country: 'U.S. Minor Outlying Islands' },
    { country_code: 'PU', country: 'U.S. Miscellaneous Pacific Islands' },
    { country_code: 'VI', country: 'U.S. Virgin Islands' },
    { country_code: 'UG', country: 'Uganda' },
    { country_code: 'UA', country: 'Ukraine' },
    { country_code: 'AE', country: 'United Arab Emirates' },
    { country_code: 'UK', country: 'United Kingdom' },
    ...
    { country_code: 'WK', country: 'Wake Island' },
  ...
  def self.convert_country_code(country)
    ccode = COUNTRY_CODES.select { |cc| cc[:country_code] == country.upcase }
    return '' unless ccode.any?

    ccode.first[:country_code]
  end

  def self.restaurants_in_city(cityname)
    OpenTableRestaurant.where(
      "translate(lower(city), ' ', '-') = ?",
      cityname.parameterize
    )
  end

  def self.restaurants_in_radius(
    latitude,
    longitude,
    radius,
    force_pics: false
    ...
    found =
      OpenTableRestaurant.near(
        [latitude.to_f, longitude.to_f],
        radius.to_i,
        units: :km
      ).to_a

    return found unless force_pics

    found.select { |found_restaurant| found_restaurant.profile_photo.present? }
  end
end
